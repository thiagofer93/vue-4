...
const threads = createArray(threads_length, (_, index) => {
  const id = index + 1;
...
const replies = createArray(replies_length, (_, index) => {
  const id = index + 1;
